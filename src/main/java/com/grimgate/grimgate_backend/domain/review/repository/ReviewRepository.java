...
public interface ReviewRepository extends JpaRepository<Review, Long>, JpaSpecificationExecutor<Review> {
    ...
    List<Review> findByThemeIdAndStatus(Long themeId, String status, Pageable pageable);
    List<Review> findByThemeIdAndStatus(Long themeId, String status);
    long countByThemeIdAndStatus(Long themeId, String status);
    // 내가 쓴 후기 목록(마이페이지)
